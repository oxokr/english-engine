...
SP33_CONCEPT = ("오늘은 나 얘기예요. 나로 시작할 때 아임이냐 아이냐. "
  "이게 어유 두유랑 똑같은 갈림이에요. "
  "기분이나 상태, 어디 있는지면 아임. 나 괜찮아 I'm okay, 나 여기 있어 I'm here. "
  "뭘 가졌거나 하거나 필요하면 아이 더하기 동사. 나 차 있어 I have, 나 필요해 I need, 나 할 수 있어 I can. "
  "조심할 거 하나. 같은 있어인데 갈려요. 여기 있어는 자리라서 아임, 차 있어는 가졌다라서 아이. "
  "들으면 바로 아임이냐 아이냐 한 마디. 굳히고, 번갈아, 섞어요.")

# 아임 vs 아이 노트
N_IM = "기분·상태·자리 → 아임 (I'm)."
N_I  = "가짐·함·필요 → 아이 + 동사 (I + 동사, 'm 없음)."
...
SPRINT_DAYS = [
  ...
  {"day":33, "verb":"아임/아이", "phase":"시작어 스프린트 · 첫 단어 0.1초", "ready":True, "sprint":True,
   "title":"시작어 스프린트 · 아임 vs 아이", "concept":SP33_CONCEPT, "items":[
    sp(33,1,"I'm","d1_01","나 괜찮아.","I'm",1,N_IM),
    sp(33,2,"I'm","d1_05","나 배고파.","I'm",1,N_IM),
    sp(33,3,"I'm","d1_03","나 준비됐어.","I'm",1,N_IM),
    sp(33,4,"I","d3_01","나 차 있어.","I have",1,N_I),
    sp(33,5,"I","d16_08","나 이거 필요해.","I need",1,N_I),
    sp(33,6,"I","d15_01","나 할 수 있어.","I can",1,N_I),
    sp(33,7,"I'm","d1_07","나 여기 있어.","I'm",2,"여기 있어 = 자리(상태) → 아임 (I'm here). '차 있어'(I have)랑 갈려."),
    sp(33,8,"I","d3_01","나 차 있어.","I have",2,"차 있어 = 가졌다 → 아이 (I have). '여기 있어'(I'm)랑 갈려."),
    sp(33,9,"I'm","d1_06","나 피곤해.","I'm",2,N_IM),
    sp(33,10,"I","d4_07","나 가야 해.","I have to",2,N_I),
    sp(33,11,"I'm","d13_07","나 거의 다 왔어.","I'm",2,"거의 다 왔어 = 상태 → 아임 (I'm almost there)."),
    sp(33,12,"I","d14_04","나 가고 싶어.","I want to",2,N_I),
    sp(33,13,"I'm","d1_05","나 배고파.","I'm",3,N_IM),
    sp(33,14,"I","d3_03","나 시간 없어.","I don't have",3,"시간 없어 = 가짐(없음) → 아이 (I don't have)."),
    sp(33,15,"I'm","d1_01","나 괜찮아.","I'm",3,N_IM),
    sp(33,16,"I","d16_08","나 이거 필요해.","I need",3,N_I),
   ]},
]
